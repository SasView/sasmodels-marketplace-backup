...
source = ["lib/polevl.c", "lib/sas_J1.c", "lib/kron.c", "lib/lookup_sin.c", "lib/lookup_cos.c", "integration/cylinder_high_res_integration.c", "cylinder_high_res.c"]
