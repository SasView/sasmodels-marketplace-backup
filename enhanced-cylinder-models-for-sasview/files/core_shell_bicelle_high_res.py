...
NOTE: This model is identical to the original core-shell bicelle model, but with a
...
name = "core_shell_bicelle_high_res"
...
source = ["lib/sas_Si.c", "lib/polevl.c", "lib/sas_J1.c", "lib/kron.c", "lib/lookup_sin.c", "lib/lookup_cos.c",
          "integration/core_shell_bicelle_high_res_integration.c", "core_shell_bicelle_high_res.c"]
have_Fq = True
