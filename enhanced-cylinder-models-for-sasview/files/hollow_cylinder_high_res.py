...
source = ["lib/polevl.c", "lib/sas_J1.c", "lib/kron.c", "lib/lookup_sin.c", "lib/lookup_cos.c", "integration/hollow_cylinder_high_res_integration.c", "hollow_cylinder_high_res.c"]
have_Fq = True
