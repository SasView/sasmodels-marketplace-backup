...
name = "core_shell_ellipsoid_high_res"
...
source = ["lib/sas_3j1x_x.c",  "lib/kron.c", "lib/lookup_sin.c", "lib/lookup_cos.c", "integration/core_shell_ellipsoid_high_res_integration.c","core_shell_ellipsoid_high_res.c"]
have_Fq = True
