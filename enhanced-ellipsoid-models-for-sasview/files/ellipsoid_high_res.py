...
source = ["lib/sas_3j1x_x.c", "lib/kron.c", "lib/lookup_sin.c", "lib/lookup_cos.c", "integration/ellipsoid_high_res_integration.c", "ellipsoid_high_res.c"]
have_Fq = True
